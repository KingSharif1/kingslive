    ...
    <div>
      ...
      <div className="flex">
        <input
          ...
          className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
          onKeyPress={(e) => e.key === 'Enter' && handleAddKeyword()}
        />
        <button
          onClick={handleAddKeyword}
          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-2xl transition-colors"
        >
          Add
        </button>
      </div>
...
export function TagKeywordManager({
  items,
  inputValue,
  setInputValue,
  handleAdd,
