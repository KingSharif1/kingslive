        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              ...
              <div className="text-sm text-muted-foreground font-mono">TECHNOLOGIES I USE</div>
            </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
              {[
                ...
                <div
                  key={skill.name}
                  className="group flex flex-col items-center justify-center p-4 rounded-xl border border-border hover:border-primary/50 hover:bg-accent/50 transition-all duration-300 aspect-square"
                >
